<h1>3993 - Transform Binary String Using Subsequence Sort</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/transform-binary-string-using-subsequence-sort/">transform-binary-string-using-subsequence-sort</a></h2><p>You are given a <span data-keyword="binary-string">binary string</span> <code>s</code>.</p>
