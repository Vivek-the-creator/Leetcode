<h1>4031 - Palindromic Subarray Sum</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/palindromic-subarray-sum/">palindromic-subarray-sum</a></h2><p>You are given an integer array <code>nums</code>.</p>
