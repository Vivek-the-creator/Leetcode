<h1>4307 - Exactly One Consecutive Set Bits Pair</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/exactly-one-consecutive-set-bits-pair/">exactly-one-consecutive-set-bits-pair</a></h2><p>You are given an integer <code>n</code>.</p>
